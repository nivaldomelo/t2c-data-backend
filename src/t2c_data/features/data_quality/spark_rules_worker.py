    ...
    *,
    ...
    with SessionLocal() as session:
        ...
        try:
            ...
            result_file = temporary_result_file(job_type="rules", job_run_id=job_run_id, config=spark_config)
            rules_payload = [
                {
                    "id": r.id,
                    "name": r.name,
            ...
            logs_path = write_job_logs(job_run_id, job_type="rules", stdout_log=stdout_log, stderr_log=stderr_log, config=spark_config)
